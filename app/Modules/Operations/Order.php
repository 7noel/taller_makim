...
class Order extends Model implements Auditable
{
	...
	{
		return $this->belongsTo('App\Modules\Finances\Company', 'insurance_company_id');
	}
	public function car()
	{
