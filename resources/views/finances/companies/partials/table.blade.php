	...
	<tbody>
		...
		<tr data-id="{{ $model->id }}">
			...
			<td>
				...
				<a href="{{ route( $routes['edit'] , $model) }}" class="btn btn-primary btn-sm" title="Editar">{!! $icons['edit'] !!}</a>
				<a href="#" class="btn-delete btn btn-danger btn-sm" title="Eliminar">{!! $icons['remove'] !!}</a>
			</td>
		</tr>
		@endforeach
	</tbody>
