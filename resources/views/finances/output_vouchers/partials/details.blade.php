...
<template id="template-row-item">
	<tr>
		...
		<td width="100px"> <span class='form-control form-control-sm txtTotal text-right withoutTax' data-total></span> </td>
		<td width="100px"> <span class='form-control form-control-sm txtPriceItem text-right withTax' data-total></span> </td>
