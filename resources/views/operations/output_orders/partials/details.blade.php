...
<table class="table table-sm table-responsive">
	...
	@foreach($model->details as $detail)
		...
		<tr data-id="{{ $detail->id }}">
			...
			{!! Form::hidden("details[$i][category_id]", $detail->category_id, ['class'=>'categoryId','data-categoryid'=>'']) !!}Form::hidden("details[$i][sub_category_id]", $detail->sub_category_id, ['class'=>'subCategoryId','data-subcategoryid'=>'']) !!}
