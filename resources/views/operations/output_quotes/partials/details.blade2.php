...
<div class="form-row">
	<div class="col-sm-1">
		{!! Form::select('type_detail', ['p' => 'Producto', 's' => 'Servicio'], 'p', ['class'=>'form-control form-control-sm']) !!}
	</div>
	<div class="col-sm-1">
		{!! Form::text('txtCodigo', null, ['class'=>'form-control form-control-sm', 'placeholder'=>'Codigo', 'disabled']) !!}
	</div>
	<div class="col-sm-3">
		{!! Form::search('txtProduct', null, ['class'=>'form-control form-control-sm', 'placeholder'=>'Producto o Servicio']) !!}
	</div>
	<div class="col-sm-1">
		{!! Form::number('txtCantidad', null, ['class'=>'form-control form-control-sm', 'placeholder'=>'Cantidad']) !!}
	</div>
	<div class="col-sm-1">
		{!! Form::number('txtValor', null, ['class'=>'form-control form-control-sm', 'placeholder'=>'Valor']) !!}
	</div>
	<div class="col-sm-1">
		{!! Form::number('txtPrecio', null, ['class'=>'form-control form-control-sm', 'placeholder'=>'Precio']) !!}
	</div>
	<div class="col-sm-1">
		{!! Form::number('txtDesc1', null, ['class'=>'form-control form-control-sm', 'placeholder'=>'Desc %']) !!}
	</div>
	<div class="col-sm-1">
		{!! Form::number('txtTotal', null, ['class'=>'form-control form-control-sm', 'placeholder'=>'Total', 'disabled']) !!}
	</div>
	<div class="col-sm-1">
		<a href="#" id="btnAddProduct" class="btn btn-success btn-sm" title="Agregar Producto">{!! $icons['add'] !!} Agregar</a>
		<!-- <a href="http://localhost:8000" target="popup" onClick="window.open(this.href, this.target, 'width=400px,height=400px'); return false;">Enlace a lawebera.es</a> -->
	</div>
</div>
<br>
<div class="">
