...
Route::group(['middleware'=>['auth']], function(){
	...
	Route::get('storage/products/autocomplete/{warehouse_id}', ['as' => 'productsAutocomplete2','uses' => 'Storage\ProductsController@ajaxAutocomplete']);
...
Route::group(['prefix'=>'operations', 'middleware'=>['auth', 'permissions'], 'namespace'=>'Operations'], function(){
	...
	Route::get('output_quotes/print_taller/{id}', ['as' => 'output_quotes.print_taller','uses' => 'OrdersController@print_quotes_taller']);
